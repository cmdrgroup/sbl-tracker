      ...
      <PageHeader
        ...
        actions={
          <button className="px-3 py-1.5 rounded-md bg-primary text-primary-foreground text-[12px] font-medium flex items-center gap-1.5">
            <Sparkles className="h-3.5 w-3.5" /> Generate next chapter
          </button>
        }
      />
      ...
      <div className="grid grid-cols-3 gap-3">
        <Panel title="Overall Completion" subtitle="Across 7 departments">
          <div className="flex items-end gap-2">
            <span className="font-display text-[56px] leading-none font-semibold">{pct}</span>
              ...
              <div className="flex items-start justify-between mb-3">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-display text-[18px] font-semibold">{d.name}</span>
                  </div>
                  <div className="text-[11px] text-muted-foreground mt-1">Owner · {d.owner}</div>
                </div>
                <div className="text-right">
                  <div className="font-display text-[28px] leading-none font-semibold">{pct}<span className="text-[12px] text-muted-foreground">%</span></div>
                </div>
              </div>
