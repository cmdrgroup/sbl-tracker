      ...
      <Panel accent>
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="font-display text-[20px] leading-snug mt-1.5 italic text-foreground">
      ...
      <div className="grid grid-cols-2 gap-3">
        {INSIGHTS.map((ins) => {
          ...
          return (
            <div
              key={ins.title}
              className={`bg-gradient-to-br to-transparent bg-card border rounded-xl p-5 ${SEV[ins.severity]}`}
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="font-display text-[18px] font-semibold leading-tight">{ins.title}</div>
